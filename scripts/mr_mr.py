...
def get_seg(II, MSEG, t, i1_idx, i1_len, mpoint1, i1, i2_idx, i2_len, mpoint2, i2):
    u = 0
    M = len(II)
    coll = []
...
def get_ms_ms_intersections2(msegs0, msegs1, initial_state, final_state, op = 1):
    intersections = None
...
intersections, M, I = get_ms_ms_intersections2(MS, [ms1], initial_state, final_state, 1)
