...
def get_msegs_intersections(ms1, ms2, i):
...
def get_mr_mr_intersections(MS0, MS1, initial_state, final_state, op = 1):
    ...
    for ms0 in msegs0:
        for ms1 in msegs1:
            if get_msegs_intersections(ms0, ms1, interval):
                return True
...
if operation == Operation.Intersects.value or              \
   ...
   operation == Operation.Overlaps.value:
    ...
    print(str(pred))
    #print(str(pred) + ' ' + str(initial_state) + ' ' + str(final_state))
    ...
    if operation == Operation.Crosses.value:
