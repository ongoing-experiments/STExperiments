...
def get_corr2(reg0, reg1, i1, i2, i3, mpoint1, mpoint2, mpoint3, IT1, IT2, IT3, t, t1, reverse, reg2):
    Geometries = []
...
def get_corr3(reg0, reg1, i1, i2, i3, mpoint1, mpoint2, mpoint3, IT1, IT2, IT3, t, reverse, reg2):
    Geometries = []
    eps = 0.00001
    #spatial_eps = 0.000000001
    spatial_eps = 0.000000001
...
def get_samples_for_out7(MS, G, G1, G2, MSEG, MSEG1, MSEG2, II, II1, II2, ms1, ms2, ms3, i, n_samples, s, i1, i2, i3, mpoint1, mpoint2, mpoint3, reg_dict, IDICT, IDICT1, IDICT2):
    ...
    for e in P:
        ...
        if isinstance(UI, Interval):
            ...
            C0, G0, ALT, NALT = get_corr2(reg0, triangle0, i1, i2, i3, mpoint1, mpoint2, mpoint3, IT01, IT02, IT03, t0, t1, False, triangle2)
    ...
    for e in region_inside_period:
        if isinstance(e, Interval):
            ...
            # get observations
            get_obs_from_unit(ur, n_samples)
        else:
            print(e, 'all: todo')
...
def get_obs_from_unit(unit, n_samples):
    n = (n_samples - 1)
...
#p_min_vertex_id = l_most_coord(p.exterior.coords)
#q_min_vertex_id = l_most_coord(q.exterior.coords)
...
#tri1_min_vertex_id = l_most_coord(tri_1.exterior.coords)
#tri3_min_vertex_id = l_most_coord(tri_3.exterior.coords)

t0 = 1000
t1 = 2000

#reg_m_segs = get_moving_segs_from_observations2(p, q, t0, t1, p_min_vertex_id, q_min_vertex_id)
...
#print(p_min_vertex_id, q_min_vertex_id)
#print(tri1_min_vertex_id, tri3_min_vertex_id)
#sys.exit()

#

#mpoint1 = str(sys.argv[3])
#mpoint2 = str(sys.argv[4])

#mpoint1 = '695.86,589.19#806.89,654.29#866.77,758.36#1000,2000'
#mpoint2 = '745.27,511.29#878.40,601.39#938.86,706.62#1000,2000'
...
#initial_state, final_state = get_states(p_wkt, q_wkt, mpoint1)

#mpoint1 = create_moving_point([mpoint1])
...
"""
-(1.02907253515921e+23*t**6 + 5.31369836881899e+35*t**5 - 3.8999628187391e+39*t**4 + 8.96879527225381e+42*t**3 - 8.44546981788519e+45*t**2 + 1.50189434734654e+48*t + 2.94251182433602e+51)/(5.95903676000005e+26*t**4 + 2.74442402708568e+39*t**3 - 1.11791022692127e+43*t**2 + 1.75351330443477e+46*t - 1.08777492380643e+49)
-(4.11698576167202e+22*t**6 + 1.37154982430906e+35*t**5 - 1.10702456811311e+39*t**4 + 3.5267857030672e+42*t**3 - 5.59606881698965e+45*t**2 + 2.64340570434936e+48*t + 1.17713435085807e+51)/(2.38439420000002e+26*t**4 + 8.78799171977478e+37*t**3 - 8.62151048684832e+41*t**2 + 4.26564010551861e+45*t - 4.6905653576949e+48)
1.0e-7*(2.26385630075267e+18*t**6 + 5.7476358131235e+33*t**5 + 4.29754781313501e+37*t**4 - 1.02527127673072e+42*t**3 + 2.54595173711829e+45*t**2 + 6.24366668719428e+46*t - 1.15074220989719e+51)/(4.30375052e+19*t**4 - 6.7527876067783e+31*t**3 + 1.56352571474147e+35*t**2 + 1.87391744044417e+38*t - 2.45921054272895e+41)
-(5.14533180504002e+21*t**6 - 1.01538922900938e+34*t**5 + 9.87310321341404e+37*t**4 - 3.19097369069936e+41*t**3 + 2.47212117564761e+44*t**2 + 4.36659864516696e+47*t - 4.5129867985723e+50)/(5.67038820000002e+25*t**4 - 6.26721154358012e+37*t**3 + 5.43091626148281e+41*t**2 - 1.38671517306398e+45*t + 9.67381793631623e+47)
(1.02904578049863e+22*t**6 + 6.62389701482971e+33*t**5 - 6.44184708284543e+37*t**4 + 2.6227131346258e+41*t**3 - 4.55369292141767e+44*t**2 + 1.55503585879834e+47*t + 1.56688128441405e+50)/(-8.65085895000005e+25*t**4 + 2.25213156185819e+37*t**3 + 1.06360891080914e+40*t**2 - 3.93961186592996e+44*t + 4.76051706676594e+47)
-(1.02913324764601e+24*t**6 - 1.51762200786383e+35*t**5 + 2.81100093358268e+39*t**4 - 1.93264083802111e+43*t**3 + 3.10415227346458e+46*t**2 + 2.36886094436373e+49*t - 2.70165525518223e+52)/(1.13404644000001e+28*t**4 + 7.75750830338166e+39*t**3 - 3.93186026537629e+42*t**2 - 7.4518019319288e+46*t + 5.64443582491974e+49)
(-3.18997812000002e+20*t**6 + 1.57336209314509e+37*t**5 - 1.51029091054066e+41*t**4 + 5.39604862125874e+44*t**3 - 7.89005333993513e+47*t**2 + 1.73512149852079e+50*t + 3.24512305938231e+53)/(1.30960000000002e+24*t**4 - 3.32903248850493e+40*t**3 + 3.68763933630328e+44*t**2 - 1.18612802845519e+48*t + 1.01811112048704e+51)
-(3.08707560000002e+18*t**6 + 5.87590826854935e+34*t**5 - 1.04445553168945e+39*t**4 + 6.028031931312e+42*t**3 - 1.24762997572977e+46*t**2 + 7.04550135557613e+48*t + 3.47428550582021e+51)/(1.68040000000001e+22*t**4 - 9.64303248850506e+38*t**3 + 8.59389336303243e+41*t**2 + 8.63593221544821e+45*t - 1.29599387951297e+49)
-(2.05794749748001e+22*t**6 + 4.37854284278221e+34*t**5 + 3.46179923095784e+37*t**4 - 2.24368464790114e+42*t**3 + 6.51618471173132e+45*t**2 - 5.06307390902657e+48*t - 1.34487965843955e+51)/(1.1608028000001e+25*t**4 + 1.07554436156225e+39*t**3 - 2.85328813765206e+42*t**2 - 1.17643399615817e+45*t + 5.87737548921887e+48)
"""
...
if print_intersection_information:
    print(get_intersection_information(intersections, MS, [ms1], operation))
