...
proc_end_exec_time, n_invalid_geoms, n_complex_geoms = get_samples_for_out7(MS, G, G1, G2, M, M1, M2, I, I1, I2, ms1, ms2, ms3, interval, n_samples, intersections, i1, i2, i3, mpoint1, mpoint2, mpoint3, reg_dict, IDICT, IDICT1, IDICT2)
...
if PRINT_TEST_INFO:
    ...
    day, hour, minutes, seconds = seconds_to_time(int(proc_exec_time))
    #print('Time: ' + format(hour, precision) + ':' + format(minutes, precision) + format(seconds, precision) + 'sec')
