...
import exp.MRMSExp2;
import exp.MRMTExp;
import setoperations.MRMRInt;
import stpredicates.MRMPPred;
import stpredicates.MRMRPred;
...
public class VLDB extends JFrame 
{
    ...
    private JButton mr_ms_exp_bt_1;
    private JButton mr_mr_exp_bt_2;
    private JButton mr_mt_exp_bt;
    private JButton intersection_bt;
    private JLabel lblSetOperations;
	...
	public void draw_UI() 
	{
		...
		viz_p = new JPanel();
		viz_p.setLocation(189, 10);
		
		viz_p.setSize(916, 590);
	    ...
	    mr_p_i_bt.setBounds(10, 87, 167, 23);
	    contentPane.add(mr_p_i_bt);
	    
	    mr_p_i2_bt = new JButton("(MR, MR) Predicates");
	    mr_p_i2_bt.setFont(new Font("Tahoma", Font.BOLD, 11));
	    mr_p_i2_bt.setBounds(10, 110, 167, 23);
	    contentPane.add(mr_p_i2_bt);
	    
	    mr_ms_exp_bt_1 = new JButton("(MS, MR) Exp 1");
	    mr_ms_exp_bt_1.setBounds(10, 271, 167, 23);
	    contentPane.add(mr_ms_exp_bt_1);
	    mr_ms_exp_bt_1.setFont(new Font("Tahoma", Font.BOLD, 11));
	    
	    mr_mr_exp_bt_2 = new JButton("(MS, MR) Exp 2");
	    mr_mr_exp_bt_2.setBounds(10, 296, 167, 23);
	    contentPane.add(mr_mr_exp_bt_2);
	    mr_mr_exp_bt_2.setFont(new Font("Tahoma", Font.BOLD, 11));
	    
	    mr_mt_exp_bt = new JButton("(MT, MR) Exp 1");
	    mr_mt_exp_bt.setBounds(10, 321, 167, 23);
	    contentPane.add(mr_mt_exp_bt);
	    mr_mt_exp_bt.setFont(new Font("Tahoma", Font.BOLD, 11));
	    
	    intersection_bt = new JButton("(MR, MR) Intersection");
	    intersection_bt.setBounds(10, 186, 167, 23);
	    contentPane.add(intersection_bt);
	    intersection_bt.setFont(new Font("Tahoma", Font.BOLD, 11));
	    
	    JLabel lblExperiments = new JLabel("Experiments:");
	    lblExperiments.setForeground(new Color(0, 0, 255));
	    lblExperiments.setFont(new Font("Tahoma", Font.BOLD, 14));
	    lblExperiments.setBounds(10, 249, 167, 16);
	    contentPane.add(lblExperiments);
	    
	    JLabel lblStPredicates = new JLabel("ST Predicates:");
	    lblStPredicates.setForeground(Color.BLUE);
	    lblStPredicates.setFont(new Font("Tahoma", Font.BOLD, 14));
	    lblStPredicates.setBounds(10, 66, 167, 16);
	    contentPane.add(lblStPredicates);
	    
	    lblSetOperations = new JLabel("Set Operations:");
	    lblSetOperations.setForeground(Color.BLUE);
	    lblSetOperations.setFont(new Font("Tahoma", Font.BOLD, 14));
	    lblSetOperations.setBounds(10, 165, 167, 16);
	    contentPane.add(lblSetOperations);
	}
	...
	public void add_listeners()
	{
        ...
        intersection_bt.addActionListener(new ActionListener() 
    	{
			...
			{
				MRMRInt msmp = new MRMRInt(d);
				msmp.setVisible(true);
				jp.repaint();
			}
		});
        
        mr_ms_exp_bt_1.addActionListener(new ActionListener() 
    	{
			public void actionPerformed(ActionEvent arg0) 
			{
				MRMSExp1 msmp = new MRMSExp1(d);
				msmp.setVisible(true);
				jp.repaint();
			}
		});
    	...
    	mr_p_i_bt.addActionListener(new ActionListener() 
    	{
			public void actionPerformed(ActionEvent arg0) 
			{
				MRMPPred msmp = new MRMPPred(d);
				msmp.setVisible(true);
				jp.repaint();
			}
		});
    	
    	mr_mr_exp_bt_2.addActionListener(new ActionListener() 
    	{
			public void actionPerformed(ActionEvent arg0) 
			{
				MRMSExp2 msmp = new MRMSExp2(d);
				msmp.setVisible(true);
				jp.repaint();
			}
		});
    	
    	mr_mt_exp_bt.addActionListener(new ActionListener() 
    	{
			public void actionPerformed(ActionEvent arg0) 
			{
				MRMTExp msmp = new MRMTExp(d);
				msmp.setVisible(true);
				jp.repaint();
			}
		});
