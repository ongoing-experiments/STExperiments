...
public class MRMSExp2 extends JFrame 
{
	...
	public void draw_UI() 
	{
		setTitle("MR MS Intersection Experiment 2");
	    ...
	    p1.setToolTipText("MR initial observation.");
	    p1.setBackground(SystemColor.controlLtHighlight);
	    p1.setBounds(10, 153, 155, 36);
	    contentPane.add(p1);
	    
	    q1 = new JTextArea();
	    q1.setToolTipText("MR final observation.");
	    ...
	    P2.setToolTipText("MP1 trajectory.");
	    ...
	    Q2.setToolTipText("MP2 trajectory.");
