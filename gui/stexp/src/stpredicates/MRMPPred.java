...
public class MRMPPred extends JFrame 
{
	...
	{	
		...
		*/
    	...
    	test_desc_tp.setText("MP, MR are: Disjoint > touch > Within(MP, MR) > touch > Gisjoint. MP trajectory is linear.");
        ...
        protected void paintComponent(Graphics g)
		{
			...
			try 
			{
	    		...
	    		if(mr_p_i != null)
	    		{
	    			...
	    			geom = reader.read(mr_p_i[geom_to_show_id * Nr + (Nr - 2)]);
	...
	public void draw_UI() 
	{
		setTitle("MR x MP ST Predicates");
	    ...
	    n_samples_tx.setBounds(8, 340, 65, 20);
	    ...
	    mr_p_tx.setToolTipText("Moving region initial observation.");
	    ...
	    mp_data_tx.setToolTipText("Moving point.");
	    mp_data_tx.setBackground(Color.WHITE);
	    mp_data_tx.setText("755,489#895,774#1000,2000");
	    mp_data_tx.setBounds(8, 235, 155, 36);
	    ...
	    pass_through_control_points_cb.setBounds(8, 275, 155, 23);
	    ...
	    print_intersection_information_cb.setBounds(8, 294, 155, 23);
	    ...
	    print_solver_execution_time_cb.setBounds(8, 313, 155, 23);
	    ...
	    p_radius_tx.setBounds(8, 382, 65, 20);
	    ...
	    s_precision_tx.setBounds(8, 403, 65, 20);
	    ...
	    n_dec_dig_tx.setBounds(98, 403, 65, 20);
	    ...
	    mr_q_tx.setToolTipText("Moving region final observation.");
	    ...
	    btnTest1.setBounds(1115, 380, 155, 25);
	    contentPane.add(btnTest1);
	    
	    btnTest2 = new JButton("Test 2");
	    btnTest2.setBounds(1115, 408, 155, 25);
	    contentPane.add(btnTest2);
	    
	    btnTest3 = new JButton("Test 3");
	    btnTest3.setBounds(1115, 436, 155, 25);
	...
	public void add_listeners()
	{
        ...
        btnTest2.addActionListener (new ActionListener () 
        {
            public void actionPerformed(ActionEvent e) 
            {
            	mp_data_tx.setText("802.826,764.752#990.308,633.951#1000,2000");
            	test_desc_tp.setText("MP, MR are: Disjoint > touch > Within(MP, MR) > touch > Gisjoint > touch > Within(MP, MR) > touch > Gisjoint. MP trajectory is linear.");
            }
        });        
        ...
        btnTest3.addActionListener (new ActionListener () 
        {
            public void actionPerformed(ActionEvent e) 
            {
            	mp_data_tx.setText("802.826,764.752#896.5,690.5#990.308,633.951#1000,2000");
            	test_desc_tp.setText("MP, MR are: Disjoint > touch > Within(MP, MR) > touch > Gisjoint > touch > Within(MP, MR) > touch > Gisjoint. MP trajectory is non-linear.");            	
            	//test_desc_tp.setText("MP, MR are: Disjoint > touch > Within(MP, MR) > touch > Gisjoint. MP trajectory is non-linear.");
            }
        });
    	...
    	mr_p_i_bt.addActionListener(new ActionListener() 
    	{
			public void actionPerformed(ActionEvent arg0) 
			{
				...
				*/
				...
				cmd[8] = String.valueOf(num_samples);
				//cmd[9] = intervals[idx];
				cmd[9] = interval;
				cmd[10] = prec;
				cmd[11] = n_dec_dig;
