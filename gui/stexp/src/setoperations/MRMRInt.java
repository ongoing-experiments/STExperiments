...
public class MRMRInt extends JFrame 
{
	...
	{	
		...
		*/
		...
		test_desc_tp.setText("Intersection between a moving iceberg and a moving triangle. Relationship over time: Disjoint > touch > Within(triangle, iceberg) > touch > Disjoint. The functions defining the trajectories of the intersection points between the moving segments of the two regions, are cached.");
	}
				...
				else if(mr_p_i != null)
	    		{
	    			...
	    			gr.setPaint(Color.red);
   					...
   					if(fill.isSelected())
   					{
		   		        for (int j = 0; j < geom2.getNumGeometries(); j++)
				   			gr.fill(new LiteShape(geom2.getGeometryN(j), at, false));
   					}
   					else
		    		...
		    		*/
					...
					if(show_leg)
					{
		    		    ...
		    		    gr.setPaint(Color.red);
		    		    gr.setFont(new Font("Arial", Font.BOLD, 14));
		    		    gr.drawString("MR Intersection", 20, 140);		    		    
					}
	...
	public void draw_UI() 
	{
		setTitle("MR MR ST Intersection");
	    ...
	    p1.setToolTipText("MR1 initial observation.");
	    p1.setBackground(SystemColor.controlLtHighlight);
	    p1.setBounds(10, 153, 155, 36);
	    contentPane.add(p1);
	    
	    q1 = new JTextArea();
	    q1.setToolTipText("MR1 final observation.");
	    ...
	    JLabel setop_lb = new JLabel("Set Operations:");
	    setop_lb.setForeground(new Color(25, 25, 112));
	    setop_lb.setFont(new Font("Tahoma", Font.BOLD, 12));
	    setop_lb.setBounds(10, 81, 155, 25);
	    contentPane.add(setop_lb);
	    ...
	    test_desc_tp.setBounds(1115, 123, 155, 214);
	    ...
	    op_cb.setModel(new DefaultComboBoxModel(new String[] {"Intersection"}));
	    ...
	    P2.setToolTipText("MR2 initial observation.");
	    ...
	    Q2.setToolTipText("MR2 final observation.");
    	...
    	query_bt.addActionListener(new ActionListener() 
    	{
			public void actionPerformed(ActionEvent arg0) 
			{
				...
				*/
				...
				String[] arr = new String[num_samples * 100];
				int i = 0;
