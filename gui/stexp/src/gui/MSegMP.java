...
public class MSegMP extends JFrame 
{
	...
	public void draw_UI() 
	{
		setTitle("MR MP: Study of Approximation Curves");
	    ...
	    mr_p_tx.setToolTipText("Moving segment data.");
	    ...
	    mp_data_tx.setToolTipText("Moving point data.");
	    ...
	    mr_q_tx.setToolTipText("Moving segment data.");
