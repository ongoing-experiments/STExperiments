...
public class MRegMS extends JFrame 
{
	...
	public void draw_UI() 
	{
		setTitle("MR MS: Study of Approximation Curves");
	    ...
	    mp1_data_tx.setToolTipText("Moving point data.");
	    ...
	    mp2_data_tx.setToolTipText("Moving point data.");
	    mp2_data_tx.setText("725,439#875,734#1000,2000");
	    mp2_data_tx.setBackground(Color.WHITE);
